/* Minimal curses for the Rogue family (from the XRogue port): in-memory windows, drawn by a frontend
 * (be_x11.c on the Mac, be_web.c in the browser). Only what these games use. */
#ifndef WCURSES_H
#define WCURSES_H
#include <stdarg.h>
#include <stdio.h>
...
void be_run_end(const char *ev, const char *killer, int score); /* run-report beacon */
#define XR_SHIM 1
